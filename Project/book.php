...
<div class="heading" style="background: url(book-bg.jpg) no-repeat">
    <h1>book now</h1>
</div>
...
<!-- booking section starts-->
    <section class="booking">
        ...
        <form action="book_form.php" method="post" class="book-form">
            ...
            <button type="button" class="btn" onclick="window.location.href='../CS206_Project/index.html'">submit</button>
...
<section class="footer">
    <div class="box-container">
        <div class="box">
            <h3>quick links</h3>
            <a href="tour_home.php"> <i class="fas fa-angle-right"></i> home</a>
